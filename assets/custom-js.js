$(document).ready(function() {
  ...
  jQuery('.tt-homeslider,.top-category').wrapAll('<div class="tt-slider"></div>');
  jQuery('.feature-Product,.bestseller-collection').wrapAll('<div class="best-product shopify-section index-section"><div class="container"><div class="row"></div></div></div>');
  /*--------------- Scroll to top js -------------------*/
  ...
  var p_col = jQuery('.slider-fetureproduct').data('col');
  $('body .slider-fetureproduct').owlCarousel({
    items : p_col, //10 items above 1000px browser width
    nav : true,
    autoplay:false,
    autoplaySpeed:1500,	
...
function responsiveMenu(){
  if(jQuery(window).width() < 992) {
    ...
    $('.topcat_content').prependTo('.index-section.top-category .top-cat');
